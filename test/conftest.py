"""
This conftest file is used to make fixtures accessible throughout the entire directory. Instead
of importing them into every test file, we can declare our spark session here and use it throughout 
